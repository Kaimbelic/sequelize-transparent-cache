...
exports.MemcachedAdaptor = void 0;
const hour = 60 * 60;
class MemcachedAdaptor {
    ...
    set(key, value) {
        return new Promise((resolve, reject) => {
            this.client.set(this._withNamespace(key), JSON.stringify(value), this.lifetime, error => (error ? reject(error) : resolve()));
        });
    }
    get(key) {
        return new Promise((resolve, reject) => {
...
exports.MemcachedAdaptor = MemcachedAdaptor;
exports.default = MemcachedAdaptor;
